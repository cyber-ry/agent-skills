...
Updated: 2026-08-06T09:51:03.682Z
...
Source output: `eval-workspaces/redis-security/security/iteration-1`
...
```bash
npm run eval:baseline -- --skill redis-security --suite security --iteration iteration-1
```
